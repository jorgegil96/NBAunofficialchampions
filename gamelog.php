...
<html>
	<head>
		...
		<link href="css/game-log.css" rel="stylesheet">
						...
						if ($line > 2) {
							if ($line[2] == $holder OR $line[4] == $holder) {
								...
								<tr>
									...
									<td><?php echo "<img class='small-logo' src='img/logos/icons/".$teams[$line[4]].".png'> ".$line[4]; ?></td>
									<td><?php echo $line[5]?></td>
									<td><?php echo "<img class='small-logo' src='img/logos/icons/".$teams[$line[2]].".png'> ".$line[2]; ?></td>
